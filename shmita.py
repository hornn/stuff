...
def shmita_year():
    ...
    year += 1
    # 2. discard centuries, because each century is like 2 yovels (jubilees) - 50 years, which is 7 shmitot.
    centuries_num = year / 100
    year = year % 100
    # 3. add 2 years for each discarded century, because 7 shmitot is 49, not 50,
    # so we need to account the missing years. (According to Rabbi Yehuda)
